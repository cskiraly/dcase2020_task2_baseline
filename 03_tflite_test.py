...
if __name__ == "__main__":
    ...
    for idx, target_dir in enumerate(dirs):
        ...
        for id_str in machine_id_list:
            ...
            anomaly_score_csv = "{result}/tflite_anomaly_score_{machine_type}_{id_str}.csv".format(
    ...
    if mode:
        # output results
        result_path = "{result}/tflite_{file_name}".format(result=param["result_directory"], file_name=param["result_file"])
